CREATE VIEW `mlab-collaboration.mm_preproduction.extended_intermediate_uploads_DS1V`
AS # View mlab-collaboration.mm_preproduction.extended_intermediate_uploads_DS1V
# MANUALLY edited from: # 20251122PUD create fcn extended_intermediate_uploads_DS16

# This is a "schema compatable" view that mimics the downsampled tables.
# It supports all of the same columns and features, except it does not
...
-- Add the clustering columns used in the tables, although they are noops here
SELECT *, 
