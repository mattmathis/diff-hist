CREATE TABLE FUNCTION `mlab-collaboration`.mm_preproduction.access_ndt7_isp_histograms(method STRING, xAxis STRING, binSize INT64, field STRING, startDate DATE, endDate DATE, siteRegex STRING, ispCount INT64)
AS
WITH
