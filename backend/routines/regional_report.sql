CREATE TABLE FUNCTION `mlab-collaboration`.mm_preproduction.regional_report(method STRING, xAxis STRING, binSize INT64, field STRING, startDate DATE, endDate DATE, regionRegex STRING, ispRegexp STRING, ispCount INT64)
AS
WITH
